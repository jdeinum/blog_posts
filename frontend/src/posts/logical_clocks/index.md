...
<h1 style="text-align: center;">Logical Clocks</h1>
...
[here](https://github.com/jdeinum/rust_clock_sync).
...
<div style="display: flex; align-items: flex-start; margin: 0; padding: 0;">
  <!-- Mermaid Diagram (75%) -->
  <figure class="mermaid-diagram" style="flex: 2; margin: 0; padding: 0;">
    <pre class="mermaid">
sequenceDiagram
    participant A
    participant B
...
Lamport clocks have several interesting properties. Assume we have events *A*
and *B*, with lamport timestamps $L_A$ and $L_B$ respectfully, we have the
following:
...
before B, or whether they are concurrent (we don't know which came first).
...
Before we talk about comparing vector timestamps, it's noting that no two
